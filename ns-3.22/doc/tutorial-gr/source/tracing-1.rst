...
προκαθορισμένων μηχανισμών παραγωγής και την ανάλυση του περιεχομένου τους για να εξαχθούν ενδιαφέρουσες 
...
Η χρήση προκαθορισμένων μηχανισμών εξόδου έχει το πλεονέκτημα ότι δεν απαιτεί αλλαγές στον |ns3|, 
...
Εάν χρειάζεστε να προσθέσετε μερικούς εκλεκτούς tidbit των πληροφοριών στους προκαθορισμένους μηχανισμούς, αυτό 
...
Ο |ns3| παρέχει έναν άλλο μηχανισμό, που ονομάζεται Tracing, που αποφεύγει ορισμένα από τα προβλήματα που συνδέονται 
