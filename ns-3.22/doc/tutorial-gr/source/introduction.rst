...
* Ο |ns-3| είναι ενεργά εξελίξιμος με μία ενεργό, αποκρινόμενη λίστα αλληλογραφίας χρηστών, ενώ ο |ns-2| είναι μόνο ελαφρά διατηρηθεί και να μην έχει δει σημαντική ανάπτυξη σε κεντρικό δέντρο κώδικα του για πάνω από μια δεκαετία.
* Ο |ns-3| παρέχει λειτουργίες δεν είναι διαθέσιμες σε ns-2, όπως ένα περιβάλλον εκτέλεσης κώδικα εφαρμογής (επιτρέποντας στους χρήστες να τρέχουν σε πραγματικό κώδικα της εφαρμογής στον προσομοιωτή)
